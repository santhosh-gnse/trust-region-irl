...
from trust_region_irl.algorithms.gail_ppo.flax_full_jit.general_properties import GeneralProperties
from trust_region_irl.algorithms.gail_ppo.flax_full_jit.policy import get_policy
from trust_region_irl.algorithms.gail_ppo.flax_full_jit.critic import get_critic
from trust_region_irl.algorithms.gail_ppo.flax_full_jit.discriminator import get_discriminator, get_reward_approximator
            ...
            def multi_learning_and_eval_save_iteration(multi_learning_and_eval_save_iteration_carry, multi_learning_iteration_step):
                ...
                def learning_iteration(learning_iteration_carry, learning_iteration_step):
                    ...
                    if self.handle_absorbing_states:
                        gail_reward_absorbing_state = get_reward((next_states.reshape((-1,) + self.os_shape), # next state
