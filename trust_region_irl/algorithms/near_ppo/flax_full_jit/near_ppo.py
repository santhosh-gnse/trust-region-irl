...
from trust_region_irl.algorithms.near_ppo.flax_full_jit.general_properties import GeneralProperties
from trust_region_irl.algorithms.near_ppo.flax_full_jit.policy import get_policy
from trust_region_irl.algorithms.near_ppo.flax_full_jit.critic import get_critic
from trust_region_irl.algorithms.near_ppo.flax_full_jit.energy_function import get_energyfn
...
class NEAR_PPO:
    ...
    def retrain(self):
        ...
        # Re-initialize policy and critic
        ...
        def jitable_train_function(key, parallel_seed_id):
            ...
            def multi_learning_and_eval_save_iteration(multi_learning_and_eval_save_iteration_carry, multi_learning_iteration_step):
                ...
                def learning_iteration(learning_iteration_carry, learning_iteration_step):
                    ...
                    return (policy_state, critic_state, energyfn_state, env_state, key), None
