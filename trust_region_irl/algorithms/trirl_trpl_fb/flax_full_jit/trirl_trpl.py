...
from trust_region_irl.algorithms.trirl_trpl_fb.flax_full_jit.policy import get_policy
from trust_region_irl.algorithms.trirl_trpl_fb.flax_full_jit.critic import get_critic
from trust_region_irl.algorithms.trirl_trpl_fb.flax_full_jit.discriminator import get_discriminator
from trust_region_irl.algorithms.data_utils import prepare_expert_data, expert_data_spec
from trust_region_irl.algorithms.trirl_trpl_fb.flax_full_jit.trust_region_layer import *
...
class TRIRL_TRPL:
        ...
        def jitable_train_function(key, parallel_seed_id):
            ...
            def multi_learning_and_eval_save_iteration(multi_learning_and_eval_save_iteration_carry, multi_learning_iteration_step):
                ...
                def learning_iteration(learning_iteration_carry, learning_iteration_step):
                    ...
                    max_eta = jnp.max(etas)
                    dtrl_optimization_metrics["projection/max_eta"] = max_eta


                    """ Reward Correction """
                    step = self.epsilon / (1.0 + max_eta)
                    ...
                    # Logging
                    combined_metrics = {**infos, **disc_optimization_metrics, **dtrl_optimization_metrics}
    ...
    def retrain_ppo(self):
        ...
        # self.config.runner.save_model = True
