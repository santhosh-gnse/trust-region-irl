...
from trust_region_irl.environments.ant_disabled_mjx.state import State
from trust_region_irl.environments.ant_disabled_mjx.box_space import BoxSpace
from trust_region_irl.environments.ant_disabled_mjx.viewer import MujocoViewer
...
class Ant:
    def __init__(self, render, horizon=1000, feature_fn="base"):
        ...
        xml_path = (Path(__file__).resolve().parent / "data" / "ant_disabled.xml").as_posix()
        ...
        self.disabled_action_slice = slice(2, 6)
    ...
    def _step(self, state, action):
        action = action.at[self.disabled_action_slice].set(0.0)
