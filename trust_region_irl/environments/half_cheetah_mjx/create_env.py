from trust_region_irl.environments.half_cheetah_mjx.environment import HalfCheetah
from trust_region_irl.environments.half_cheetah_mjx.general_properties import GeneralProperties
