from trust_region_irl.environments.hopper_mjx.environment import Hopper
from trust_region_irl.environments.hopper_mjx.general_properties import GeneralProperties
