from trust_region_irl.environments.point_maze_mjx.environment import PointMaze
from trust_region_irl.environments.point_maze_mjx.general_properties import GeneralProperties
