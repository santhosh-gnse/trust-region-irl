from trust_region_irl.environments.walker2d_mjx.environment import Walker2D
from trust_region_irl.environments.walker2d_mjx.general_properties import GeneralProperties
