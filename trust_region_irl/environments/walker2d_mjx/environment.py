...
from trust_region_irl.environments.walker2d_mjx.state import State
from trust_region_irl.environments.walker2d_mjx.box_space import BoxSpace
from trust_region_irl.environments.walker2d_mjx.viewer import MujocoViewer
...
class Walker2D:
    ...
    def get_observation(self, data):
        ...
        torso_vel_x = jnp.array([data.qvel[0]])
        torso_vel_z = jnp.array([data.qvel[1]])
        torso_ang_vel = jnp.array([data.qvel[2]])
        joint_velocities = data.qvel[3:]
